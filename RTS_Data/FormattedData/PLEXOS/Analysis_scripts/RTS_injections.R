...
wd = "//plexossql/Data/bmcbenne/RTS-GMLC-geodecomp/RTS-GMLC/RTS_Data/FormattedData/PLEXOS/MIP_0.1_notx"
setwd(wd)
...
if(decomposed){
  ...
  output.dir = paste0("//nrelqnap01d/PLEXOS/Projects/GMLC-MSPCM/geo-decomp-data-decomposed-notx")
  ...
  output.dir = paste0("//nrelqnap01d/PLEXOS/Projects/GMLC-MSPCM/geo-decomp-data-nondecomposed-notx")
