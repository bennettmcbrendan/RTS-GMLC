...
MULTI_OPT_BORDER_price_flow_plots = function(voltage.threshold = 0){
    ...
    int.node.price = int.node.price[!(scenario == "Model c_2024_EI_01")]
    ...
    int.region.NI = int.region.NI[!(scenario == "Model c_2024_EI_01")]
