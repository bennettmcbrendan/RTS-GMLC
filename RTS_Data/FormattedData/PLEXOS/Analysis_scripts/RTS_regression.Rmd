...
params:
  Solutions.directory:
    label: Pick directory with solutions (this should be fullpathto..HERE/Model ..
      Solution/.db)
    value: //plexossql/Data/bmcbenne/RTS-GMLC-geodecomp/RTS-GMLC/RTS_Data/FormattedData/PLEXOS/All_75_100
---
...
solution.names = c('Model REAL_TIME_FIXALL Solution',
                  'Model REAL_TIME_C_FIXALL Solution')
