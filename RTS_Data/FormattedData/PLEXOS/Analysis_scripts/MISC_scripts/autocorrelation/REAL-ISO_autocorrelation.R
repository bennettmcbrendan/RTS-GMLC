...
# one-interval price and flow autocorrelation
  ...
  int.correlation[,Interchange.shift:=shift(Interchange,tau,type = 'lag'),by = c('Interface')]
  int.correlation[,Price.shift:=shift(Price,tau,type = 'lag'),by = c('Interface')]
...
ggsave('EI_ISO_autocorrelation.png',p,height = 2.5,width = 4.5)
