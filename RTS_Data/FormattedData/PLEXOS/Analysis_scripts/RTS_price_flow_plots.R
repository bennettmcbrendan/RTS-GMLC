...
compare.table[Price >= 0 & Flow <= 0 & quad.0 == 0,II:=1]
compare.table[Price < 0 & Flow < 0 & quad.0 == 0,III:=1]
compare.table[Price <= 0 & Flow >= 0 & quad.0 == 0,IV:=1]
...
quadrants[variable == 'I',x:=250]
quadrants[variable == 'I',y:=75]
quadrants[variable == 'II',x:=-325]
quadrants[variable == 'II',y:=75]
quadrants[variable == 'III',x:=-325]
quadrants[variable == 'III',y:=-75]
quadrants[variable == 'IV',x:=250]
quadrants[variable == 'IV',y:=-75]
...
if(add.quadrants){
    ...
    p1 <- p1 + geom_label(data = quadrants,aes(x = x,y = y,label = variable),
