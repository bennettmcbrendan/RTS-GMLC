...
solutions.dir <- "//nrelqnap02/PLEXOS CEII/Projects/Interconnections_Seam_Plexos/Continental/geodecomp_compare"
...
ggsave('plots/EI_single-opt-border_hex.png',p,height = 5.5,width = 3.5)
