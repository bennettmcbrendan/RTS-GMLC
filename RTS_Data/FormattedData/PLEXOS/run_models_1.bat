...
.\PLEXOS64.EXE \\plexossql\Data\bmcbenne\RTS-GMLC-geodecomp\RTS-GMLC\RTS_Data\FormattedData\PLEXOS\RTS-GMLC-GeoDecomp_bygen.xml \m "REAL_TIME" \n
.\PLEXOS64.EXE \\plexossql\Data\bmcbenne\RTS-GMLC-geodecomp\RTS-GMLC\RTS_Data\FormattedData\PLEXOS\RTS-GMLC-GeoDecomp_bygen.xml \m "REAL_TIME_C" \n
